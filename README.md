...
To build the final jar and optimize the NewApp application for production, run:
...
[Service Discovery and Configuration with the JHipster-Registry]: https://www.jhipster.tech/documentation-archive/v8.7.1/microservices-architecture/#jhipster-registry
